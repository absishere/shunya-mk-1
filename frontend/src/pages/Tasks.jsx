    ...
    <div>
      ...
      <div className="grid-2">
        ...
        <div className="card" style={{height:'fit-content'}}>
          ...
          <p style={{fontSize:'0.9rem', color:'var(--text-muted)'}}>Paste your messy group chat messages here.</p>
          <textarea value={rawText} onChange={e=>setRawText(e.target.value)} style={{height:'150px', marginTop:'10px', resize:'none'}} placeholder="e.g. 'Maths assignment due tomorrow and Physics lab on Friday'" />
        ...
        <div className="card">
          <h3>📌 To-Do List</h3>
          {savedTasks.length === 0 && <div style={{padding:'20px', textAlign:'center', color:'var(--text-muted)'}}>No tasks yet.</div>}
          {savedTasks.map((t, i) => (
            <div key={i} style={{background:'rgba(255,255,255,0.03)', padding:'15px', borderRadius:'8px', marginBottom:'10px', display:'flex', justifyContent:'space-between', alignItems:'center'}}>
              ...
              <div style={{textAlign:'right'}}>
                ...
                <button className="btn btn-ghost" style={{fontSize:'0.8rem', padding:'4px 8px', marginTop:'5px'}} onClick={() => {
